...
class ChatDatabase:
    ...
    def __init__(self):
        ...
        try:
            ...
            connection_string = "mongodb+srv://prashansa:prashansa@cluster0.6j0ib8a.mongodb.net/myprofiles?retryWrites=true&w=majority"
...
# API Configuration
OLLAMA_API_KEY = "00613405f559470b8214335101459b0a.fMhEVuHqvC4moAyspFziP1R-"  # Your API key (hardcoded)
...
# Create index.html template ONLY if it doesn't already exist
# (prevents overwriting the real index.html on every server restart)
